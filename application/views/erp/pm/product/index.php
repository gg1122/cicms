...
<div class="toolbar">
    <blockquote class="layui-elem-quote">
        <a href="javascript:;" class="layui-btn layui-btn-small" data-type="addProduct">
            <i class="layui-icon">&#xe608;</i> 新增商品
        </a>
        <a href="#" class="layui-btn layui-btn-small" data-type="importProduct">
            <i class="layui-icon">&#xe608;</i> 导入商品
        </a>
        <a href="#" class="layui-btn layui-btn-small" data-type="exportProduct">
            <i class="fa fa-shopping-cart" aria-hidden="true"></i> 导出商品
        </a>
    </blockquote>
...
<table class="layui-table"
       lay-data="{height:'full',url:'/erp/pm/product/index', page:true,id:'productListForm',where:{goods_status:1},limit:10}"
       lay-filter="listForm" style="margin-left: 20px;">
    <thead>
    <tr>
        <th lay-data="{field:'product_code', width:150}">货品编码</th>
        <th lay-data="{field:'product_name', width:200}">货品全称</th>
        <th lay-data="{field:'product_short_name', width:150}">货品简称</th>
        <th lay-data="{field:'brand_name', width:150}">品牌ID</th>
        <th lay-data="{field:'product_status', width:150,templet:'#setStatus'}">货品状态</th>
...
<script src="<?= $this->config->item('base_url') ?>assets/js/erp/product.js" charset="utf-8"></script>
