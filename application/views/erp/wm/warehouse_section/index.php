...
<div class="demoTable">
    <div class="layui-btn-group ">
        <button class="layui-btn" data-type="addWarehouseSection">
            <i class="layui-icon">&#xe608;</i> 新增仓库区域
        </button>
    </div>
...
<table class="layui-table"
       lay-data="{height:'full',url:'/erp/wm/warehouse_section/index', page:true,id:'warehouseSectionForm',where:{section_status:1},limit:10}"
...
<script src="<?= $this->config->item('base_url') ?>assets/js/erp/warehouse_section.js" charset="utf-8"></script>
</body>
</html>