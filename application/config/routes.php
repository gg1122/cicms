...
*/
$route['login'] = 'sys/user/login';
$route['logout'] = 'front/logout';
$route['check_login'] = 'front/check_login';

$route['user/create'] = 'sys/user/create';
$route['user/update?(:any)'] = 'sys/user/update/$1';
$route['user'] = 'sys/user';
...
$route['menu/view/(:any)'] = 'sys/menu/view/$1';
